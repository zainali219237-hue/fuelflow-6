...
export default function AccountsReceivable() {
  ...
  const handleGenerateStatement = (customer: Customer) => {
          ...
          <div class="container">
            ...
            <div class="summary">
              <div class="summary-item">
                <div class="summary-amount">${formatCurrency(parseFloat(customer.creditLimit || '0'))}</div>
                <div class="summary-label">Credit Limit</div>
              </div>
              <div class="summary-item">
                <div class="summary-amount" style="color: #dc2626;">${formatCurrency(parseFloat(customer.outstandingAmount || '0'))}</div>
                <div class="summary-label">Outstanding Amount</div>
              </div>
              <div class="summary-item">
                <div class="summary-amount" style="color: #16a34a;">${formatCurrency(Math.max(0, parseFloat(customer.creditLimit || '0') - parseFloat(customer.outstandingAmount || '0')))}</div>
            ...
            <div style="background: #fef2f2; padding: 20px; border-radius: 8px; border-left: 4px solid #dc2626; margin-bottom: 20px;">
              <h4 style="margin: 0 0 10px 0; color: #dc2626;">Payment Required</h4>
              <p style="margin: 0;">Please settle the outstanding amount of <strong>${formatCurrency(parseFloat(customer.outstandingAmount || '0'))}</strong> at your earliest convenience.</p>
            </div>
    ...
    toast({
      ...
      description: `Account statement for ${customer.name} has been generated`,
    });
  };
